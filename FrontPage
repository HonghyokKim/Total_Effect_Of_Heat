This repository will provide example R code and simulated data for the paper:
...
Code and data are currently under development and will be available in May 2026.
